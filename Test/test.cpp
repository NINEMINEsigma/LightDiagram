...
int llama_call(const char* model_path,int model_path_length, const char* prompt,int prompt_length, int ngl, int n_predict)
{
...
int llama_ld_call(int argc, char** argv)
{
    ...
    context.init_instance_and_build_context(model, prompt, n_predict);
