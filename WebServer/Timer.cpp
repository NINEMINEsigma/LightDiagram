...
void TimerNode::setDeleted() { deleted_ = true; }
bool TimerNode::isDeleted() const { return deleted_; }
size_t TimerNode::getExpTime() const { return expiredTime_; }

TimerManager::TimerManager() {}

TimerManager::~TimerManager() {}

bool TimerCmp::operator()(std::shared_ptr<TimerNode>& a, std::shared_ptr<TimerNode>& b) const
{
